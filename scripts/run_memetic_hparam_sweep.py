...
def _extract_physical_metric_fields(d: Mapping[str, Any], prefix: str) -> Dict[str, Any]:
    ...
    return {
        ...
        f"{prefix}weighted_mean_rssi": d.get("weighted_mean_rss_dbm"),
        f"{prefix}weighted_min_rssi": d.get("weighted_min_rss_dbm"),
        f"{prefix}weighted_p5_rssi": d.get("weighted_p5_rss_dbm"),
        f"{prefix}weighted_coverage_pct": d.get("weighted_coverage_pct"),
    }
...
def _summarize_trial(
    ...
    - final    : configuration at the last GD iteration
        ...
        - weighted  : weighted_mean_rssi, weighted_min_rssi,
            weighted_p5_rssi, weighted_coverage_pct
    ...
    if primary_losses:
        ...
        for step in range(n):
            ...
            gd_rows.append({
                ...
                "weighted_mean_rssi": pm.get("weighted_mean_rss_dbm"),
                "weighted_min_rssi": pm.get("weighted_min_rss_dbm"),
                "weighted_p5_rssi": pm.get("weighted_p5_rss_dbm"),
                "weighted_coverage_pct": pm.get("weighted_coverage_pct"),
            })
        gd_fieldnames = [
            "step", "primary_loss", "softmin_loss", "coverage_loss",
            "repulsion_loss", "mean_rssi", "min_rssi", "p5_rssi", "coverage_pct",
            "weighted_mean_rssi", "weighted_min_rssi", "weighted_p5_rssi",
...
def main() -> int:
    ...
    for index, trial in enumerate(trials, start=1):
        ...
        fieldnames = [
            ...
            "ga_best_weighted_mean_rssi",
            "ga_best_weighted_min_rssi",
            "ga_best_weighted_p5_rssi",
            "ga_best_weighted_coverage_pct",
            ...
            "gd_initial_weighted_mean_rssi",
            "gd_initial_weighted_min_rssi",
            "gd_initial_weighted_p5_rssi",
            "gd_initial_weighted_coverage_pct",
            ...
            "gd_best_weighted_mean_rssi",
            "gd_best_weighted_min_rssi",
            "gd_best_weighted_p5_rssi",
            "gd_best_weighted_coverage_pct",
            ...
            "gd_final_weighted_mean_rssi",
            "gd_final_weighted_min_rssi",
            "gd_final_weighted_p5_rssi",
            "gd_final_weighted_coverage_pct",
            # Timing and counts
            "ga_duration_sec",
            "gd_duration_sec",
            "total_duration_sec",
